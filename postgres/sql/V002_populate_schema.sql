...
--! CRIA USUARIO --!
insert into nexushub_platform.application_user (id, name, username, login, password,
    is_account_non_expired, is_account_nonlocked, is_credentials_non_expired, is_enabled)
        values ('f7467ed7-624e-4834-94c3-388dc6ec3072', 'arthur mascaro', 'arthur', 'admin', 'admin', true, true, true, true);

--! CRIA MATERIAS PARA USUÁRIO --!
insert into nexushub_platform.subject (id, name, difficulty, user_id, color)
